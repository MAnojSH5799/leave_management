...
const Home = () => {
  ...
  useEffect(() => {
    axios.get('https://leave-management-backend-three.vercel.app/getLeave/'+userData[0].name)
    .then(result => {
  ...
  const handleSubmit = (e) => {
    ...
    // console.log(employee)
    axios.post('https://leave-management-backend-three.vercel.app/leaveapply', 
    {...employee,
