...
const EditLeaveForm = () => {
    ...
    const [employee, setEmployee] = useState({
      ...
      useEffect(()=> {
        axios.get('https://leave-management-backend-three.vercel.app/Leave_employee/'+id)
        .then(result => {
            setEmployee({
                ...employee,
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.put('https://leave-management-backend-three.vercel.app/edit_leave_form/'+id, employee)
        .then(result => {
